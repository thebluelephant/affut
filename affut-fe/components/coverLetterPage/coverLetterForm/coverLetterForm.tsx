...
interface CoverLetterFormProps {
    ...
    disabledField : {limitReached : boolean , cantAccess : boolean}
}
...
export const CoverLetterForm : NextPage<CoverLetterFormProps> = ({generateLetter, disabledField}) => {
  ...
  const disabledFieldsFromParent = disabledField.cantAccess || disabledField.limitReached 
    ...
    <>    
      <div className={s.form}>
        <div className={s.form__fields}>
          ...
          <div className={`${s.field}`}>
            <div>             
              ...
              <input disabled={disabledFieldsFromParent} id="firstname" type="text" onChange={(e) => onFormChange('firstname', e.target.value)}/>
            </div>
            <div>   
              <label htmlFor="lastname">Votre nom</label>
              <input disabled={disabledFieldsFromParent} id="lastname" type="text" onChange={(e) => onFormChange('lastname', e.target.value)}/>
            </div>
            <div>
              <label htmlFor="job">Votre métier</label>
              <input disabled={disabledFieldsFromParent} id="job" type="text" onChange={(e) => onFormChange('job', e.target.value)}/>
            </div>
          </div>
          <div className={s.field}>
            ...
            <ChipInput
              ...
              disabled={disabledFieldsFromParent} 
              classes={{
                root: s.chipInput,
                chip: s.chip
              }}
        ...
        <div className={s.form__buttons}>
          {!disabledField.cantAccess && disabledField.limitReached && <p className={s.disabledFields}>Vous ne pouvez plus générer de lettre ce mois ci, rendez-vous dans quelques temps !</p>}
          <Button title="Generer" type={isEmpty || disabledFieldsFromParent ? "disabled" : "primary"} onButtonClick={() => generateLetter(form)}  />
        </div>
